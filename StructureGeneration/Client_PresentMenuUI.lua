...
Game.SendGameCustomMessage('Updating Counter', {data.Counters[Game.Us.ID]}, function(showMarket) end);
Game.SendGameCustomMessage('Updating Markets', {data.Markets[Game.Us.ID]}, function(showMarket) end);
